      ...
      <div className="absolute right-2 top-1/2 flex -translate-y-1/2 items-center gap-1.5">
        {value ? (
          <button
            ...
            className="rounded-md p-2 text-faint transition-colors hover:bg-zinc-100 hover:text-ink sm:p-1.5"
          >
            <svg aria-hidden className="h-4 w-4 sm:h-3.5 sm:w-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round">
        ...
        <span
          className="whitespace-nowrap rounded-full bg-accent-tint px-2.5 py-1 text-xs font-medium text-accent-ink-strong sm:px-2 sm:py-0.5 sm:text-[11px]"
          aria-live="polite"
        >
